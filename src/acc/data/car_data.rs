...
pub mod cars {
    ...
    pub const LAMBORGHINI_HURACAN_GT3: Car =Car::new("Lamborghini Huracan GT3", "Lamborghini", GT3);
    pub const MCLAREN_650S_GT3: Car = Car::new("McLaren 650S GT3", "McLaren", GT3);
    pub const NISSAN_GT_R_NISMO_GT3_2018: Car =Car::new("Nissan GT-R Nismo GT3 2018", "Nissan", GT3);
    pub const BMW_M6_GT3: Car = Car::new("BMW M6 GT3", "BMW", GT3);
    pub const BENTLEY_CONTINENTAL_GT3_2018: Car =Car::new("Bentley Continental GT3 2018", "Bentley", GT3);
    ...
    pub const BENTLEY_CONTINENTAL_GT3_2015: Car =Car::new("Bentley Continental GT3", "Bentley", GT3);
    pub const AMR_V12_VANTAGE_GT3: Car = Car::new("AMR V12 Vantage GT3", "Aston-Martin", GT3);
    pub const REITER_ENGINEERING_R_EX_GT3: Car =Car::new("Reiter Engineering R-EX GT3", "Reiter-Engineering", GT3);
    ...
    pub const LAMBORGHINI_HURACAN_GT3_EVO: Car =Car::new("Lamborghini Huracan GT3 Evo", "Lamborghini", GT3);
    ...
    pub const FERRARI_488_CHALLENGE_EVO: Car =Car::new("Ferrari 488 Challenge Evo", "Ferrari", CHL);
    ...
    pub const LAMBORGHINI_HURACAN_ST_EVO2: Car =Car::new("Lamborghini Huracan ST EVO2", "Lamborghini", ST22);
    ...
    pub const LAMBORGHINI_HURACAN_EVO2: Car =Car::new("Lamborghini Huracan EVO2", "Lamborghini", GT3);
    ...
    pub const ASTON_MARTIN_VANTAGE_GT4: Car =Car::new("Aston Martin Vantage GT4", "Aston-Martin", GT4);
    ...
    pub const PORSCHE_718_CAYMAN_GT4_CLUBSPORT: Car =Car::new("Porsche 718 Cayman GT4 Clubsport", "Porsche", GT4);
